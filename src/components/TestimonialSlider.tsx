...
// import { selectReviews, selectReviewLoading, getReviewsByRole } from '@/redux/slices/reviewSlice';
...
//   // Filter for 4+ star reviews (both 4 and 5 star reviews)
//   const highRatedReviews = reviews.filter(review => review.rating >= 4);

//   // Debug logging
//   useEffect(() => {
//     console.log('TestimonialSlider - All reviews:', reviews);
//     console.log('TestimonialSlider - High rated reviews:', highRatedReviews);
//     console.log('TestimonialSlider - Loading state:', loading);
//   }, [reviews, highRatedReviews, loading]);

//   useEffect(() => {
//     // Always fetch reviews to ensure we have the latest data
...
//       prevIndex >= highRatedReviews.length - slidesToShow ? 0 : prevIndex + 1
//     );
//   };

//   const prevSlide = () => {
//     setCurrentIndex((prevIndex) => 
//       prevIndex === 0 ? highRatedReviews.length - slidesToShow : prevIndex - 1
//     );
//   };
...
//                 High-rated reviews (4-5★): {highRatedReviews.length}<br/>
...
//           {/* Navigation Buttons */}
//           {highRatedReviews.length > slidesToShow && (
//             <>
//               <button
//                 onClick={prevSlide}
...
//               {Array.from({ length: highRatedReviews.length - slidesToShow + 1 }, (_, i) => (
//                 <button
//                   key={i}
//                   onClick={() => goToSlide(i)}
