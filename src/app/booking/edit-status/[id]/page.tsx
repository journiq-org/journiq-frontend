...
// import { useParams, useRouter } from "next/navigation";
// import { useAppDispatch } from "@/redux/hook";
// import { updateBookingStatus, fetchGuideBookings } from "@/redux/slices/guideBookingSlice";
// import {
//   ArrowLeft,
//   Save,
//   X,
...
//   const dispatch = useAppDispatch();
//   const [status, setStatus] = useState("confirmed");
//   const [currentBookingStatus, setCurrentBookingStatus] = useState(""); // Add this
//   const [isUpdating, setIsUpdating] = useState(false);
//   const [isLoading, setIsLoading] = useState(true); // Add loading state

//   // Add useEffect to fetch current booking status
//   useEffect(() => {
//     const fetchBookingDetails = async () => {
//       if (!id) return;
      
//       try {
//         // You'll need to create this API endpoint or fetch from your existing bookings
//         const response = await fetch(`/api/booking/${id}`);
//         const booking = await response.json();
//         setCurrentBookingStatus(booking.status);
//         setStatus(booking.status); // Set the dropdown to current status
//       } catch (error) {
...
//             <span className="ml-2 text-slate-600">Loading booking details...</span>
//           </div>
//         </div>
//       </div>
//     );
...
//                 Current Status: <span className="font-medium capitalize">{currentBookingStatus}</span>
//               </p>
//             </div>
//           </div>
//         </div>
...
//                 <button
//                   onClick={handleUpdate}
//                   disabled={isUpdating || currentBookingStatus === 'cancelled'} // Changed this line
//                   className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 min-w-[120px] justify-center"
//                 >
//                   {isUpdating ? (
//                     <>
...
//                   ⚠️ This booking is cancelled and cannot be updated.
//                 </p>
//               )}
//             </div>
//           </div>
