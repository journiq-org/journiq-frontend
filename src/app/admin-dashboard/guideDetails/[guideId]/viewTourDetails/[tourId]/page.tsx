...
// // import { getSingleTourByGuide } from "@/redux/slices/tourSlice";
...
//   const { singleTour, loading, error } = useSelector( (state: any) => state.admin );
...
//   if (loading) return <p className="p-6">Loading tour details...</p>;
//   if (error) return <p className="p-6 text-red-500">{error}</p>;
//   if (!singleTour) return <p className="p-6">Tour not found</p>;
...
//       <Card>
//         <CardHeader>
//           <CardTitle>Highlights & Itinerary</CardTitle>
//         </CardHeader>
...
//           {tour.isBlocked ? "Blocked (Admin)" : "Not Blocked"}
//         </Badge>
//       </div>
//     </div>
//   );
...
//   Mail
// } from "lucide-react";
// import { getSingleTourByGuide, toggleBlockTour, fetchBookingsByTourId, getSingleBooking } from "@/redux/slices/adminSlice";
// import { Tour } from "@/types/tour";
...
const ReviewCard = ({ review }: { review: any }) => {
  ...
  const calculateAverageRating = () => {
    ...
    const { serviceQuality, punctuality, satisfactionSurvey } = review.experience;
    const ratings = [serviceQuality, punctuality, satisfactionSurvey].filter(r => r != null);
      ...
      <CardContent className="p-4">
        ...
        {review.experience && (
          <div className="mb-3 p-3 bg-gray-50 rounded-lg">
            <h4 className="text-sm font-medium text-gray-700 mb-2">Experience Ratings:</h4>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Service Quality:</span>
                <StarRating rating={review.experience.serviceQuality || 0} size="sm" showNumber={false} />
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Punctuality:</span>
                <StarRating rating={review.experience.punctuality || 0} size="sm" showNumber={false} />
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Satisfaction:</span>
                <StarRating rating={review.experience.satisfactionSurvey || 0} size="sm" showNumber={false} />
              </div>
            </div>
          </div>
        )}
