...
//     <>
//       <TravellerNavbar />
//       <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-6 pb-0">
...
//             <button
//               onClick={() => router.push("/traveller-dashboard/profile/edit-profile")}
//               className="bg-gradient-to-r from-[#22252c] via-[#1e3a8a] to-[#22252c] shadow-xl text-white px-8 py-3 rounded-lg font-medium flex items-center gap-2 justify-center hover:shadow-md"
//             >
//               <Edit2 size={18} />
//               Edit Profile
//             </button>
...
//               className="bg-green-100 hover:bg-green-200 text-slate-700 px-8 py-3 rounded-lg font-medium flex items-center gap-2 justify-center"
//             >
//               Change Password
//             </button>
//             <button
//               onClick={() => setOpenDialog(true)}
//               className="bg-red-600 hover:bg-red-500 text-white px-8 py-3 rounded-lg font-medium flex items-center gap-2 justify-center"
//             >
//               Delete Account
//             </button>
//           </div>
